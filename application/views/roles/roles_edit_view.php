...
<script type="text/javascript">
  jQuery(document).ready(function(){
    ...
    jQuery(document).on('submit','#edit_role_form',function(e){
      e.preventDefault();

      var role_name = jQuery('#edit_role_form #role_name').val();
      var oper = jQuery('#edit_role_form #operation').val();
      var permissions = jQuery('#edit_role_form #optgroup').val();
      var role_id = jQuery('#edit_role_form #role_id').val();
...
<div class="container-fluid">
  ...
  <div class="row clearfix">
    <div class="col-lg-12">
      <div class="card">
        <div class="header">
          <h2><strong>EDITARE: </strong><?php echo $role['name'];?> </h2>
        ...
        <div class="body">
          <?php echo form_open('roles/process_request',array("id"=>"edit_role_form")); ?>
          ...
          <div class="row clearfix">
            ...
            <div class="col-lg-10 col-md-10 col-sm-8">
              <div class="form-group">
                <input type="text" name="role_name" value="<?php echo $role['name'];?>" id="role_name"class="form-control" placeholder="Nume">
              </div>
            </div>
          </div>
          <div class="row clearfix">
