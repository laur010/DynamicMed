...
<script type="text/javascript">
  jQuery(document).ready(function(){
    ...
    jQuery(document).on('submit','#add_observation_record_form',function(e){
      e.preventDefault();

      var operation = jQuery('#add_observation_record_form #operation').val();
      var patient_id = jQuery('#add_observation_record_form #patient_id').val();

      var date_open = jQuery('#add_observation_record_form #date_open').val();
      var date_close = jQuery('#add_observation_record_form #date_close').val();
      var reference_diagnostic = jQuery('#add_observation_record_form #reference_diagnostic').val();
      var hospitalized_diagnostic = jQuery('#add_observation_record_form #hospitalized_diagnostic').val();
      var discharge_diagnostic = jQuery('#add_observation_record_form #discharge_diagnostic').val();
      var sec_discharge_diagnostic = jQuery('#add_observation_record_form #sec_discharge_diagnostic').val();
      var main_surgery = jQuery('#add_observation_record_form #main_surgery').val();
      var personal_main_surgery = jQuery('#add_observation_record_form #personal_main_surgery').val();
      var date_main_surgery = jQuery('#add_observation_record_form #date_main_surgery').val();
      var concurrent_surgery = jQuery('#add_observation_record_form #concurrent_surgery').val();
      var personal_concurrent_surgery = jQuery('#add_observation_record_form #personal_concurrent_surgery').val();
      var date_concurrent_surgery = jQuery('#add_observation_record_form #date_concurrent_surgery').val();
      var other_surgery = jQuery('#add_observation_record_form #other_surgery').val();
      var personal_other_surgery = jQuery('#add_observation_record_form #personal_other_surgery').val();
      var date_other_surgery = jQuery('#add_observation_record_form #date_other_surgery').val();
      var clinical_general_exam = jQuery('#add_observation_record_form #clinical_general_exam').val();
      var status_general_exam = jQuery('#add_observation_record_form #status_general_exam').val();
      var height_general_exam = jQuery('#add_observation_record_form #height_general_exam').val();
      var weight_general_exam = jQuery('#add_observation_record_form #weight_general_exam').val();
      var nutrition_general_exam = jQuery('#add_observation_record_form #nutrition_general_exam').val();
      var conscious_general_exam = jQuery('#add_observation_record_form #conscious_general_exam').val();
      var skin_general_exam = jQuery('#add_observation_record_form #skin_general_exam').val();
      var mucous_general_exam = jQuery('#add_observation_record_form #mucous_general_exam').val();
      var appendages_general_exam = jQuery('#add_observation_record_form #appendages_general_exam').val();
      var connective_tissue_general_exam = jQuery('#add_observation_record_form #connective_tissue_general_exam').val();
      var ganglia_system_general_exam = jQuery('#add_observation_record_form #ganglia_system_general_exam').val();
      var muscle_tissue_general_exam = jQuery('#add_observation_record_form #muscle_tissue_general_exam').val();
      var articular_system_general_exam = jQuery('#add_observation_record_form #articular_system_general_exam').val();
      var respiratory_device_general_exam = jQuery('#add_observation_record_form #respiratory_device_general_exam').val();
      var cardiovascular_device_general_exam = jQuery('#add_observation_record_form #cardiovascular_device_general_exam').val();
      var digestive_device_general_exam = jQuery('#add_observation_record_form #digestive_device_general_exam').val();
      var digestive_system_general_exam = jQuery('#add_observation_record_form #digestive_system_general_exam').val();
      var urogenital_device_general_exam = jQuery('#add_observation_record_form #urogenital_device_general_exam').val();
      var nervous_system_general_exam = jQuery('#add_observation_record_form #nervous_system_general_exam').val();
      var oral_cavity_oncology = jQuery('#add_observation_record_form #oral_cavity_oncology').val();
      var skin_oncology = jQuery('#add_observation_record_form #skin_oncology').val();
      var ganglia_oncology = jQuery('#add_observation_record_form #ganglia_oncology').val();
      var breast_oncology = jQuery('#add_observation_record_form #breast_oncology').val();
      var genital_organs_oncology = jQuery('#add_observation_record_form #genital_organs_oncology').val();
      var cytology_oncology = jQuery('#add_observation_record_form #cytology_oncology').val();
      var prostate_oncology = jQuery('#add_observation_record_form #prostate_oncology').val();
      var others_oncology = jQuery('#add_observation_record_form #others_oncology').val();
      var radiological_exam = jQuery('#add_observation_record_form #radiological_exam').val();
      var ultrasound_exam = jQuery('#add_observation_record_form #ultrasound_exam').val();
      var cytological_exam = jQuery('#add_observation_record_form #cytological_exam').val();
      var histopathological_exam = jQuery('#add_observation_record_form #histopathological_exam').val();
      var extemporaneously_exam = jQuery('#add_observation_record_form #extemporaneously_exam').val();
      var anatomopathological_exam = jQuery('#add_observation_record_form #anatomopathological_exam').val();
      var diagnostic_death = jQuery('#add_observation_record_form #diagnostic_death').val();
      var morphological_code = jQuery('#add_observation_record_form #morphological_code').val();

      var functional_explorations_name = jQuery('#add_observation_record_form #functional_explorations_name').val();
      var functional_explorations_code = jQuery('#add_observation_record_form #functional_explorations_code').val();
      var functional_explorations_nr = jQuery('#add_observation_record_form #functional_explorations_nr').val();

      var radiological_investigations_name = jQuery('#add_observation_record_form #radiological_investigations_name').val();
      var radiological_investigations_code = jQuery('#add_observation_record_form #radiological_investigations_code').val();
      var radiological_investigations_nr = jQuery('#add_observation_record_form #radiological_investigations_nr').val();

      var therapeutic_procedures_name = jQuery('#add_observation_record_form #therapeutic_procedures_name').val();
      var therapeutic_procedures_code = jQuery('#add_observation_record_form #therapeutic_procedures_code').val();
      var therapeutic_procedures_nr = jQuery('#add_observation_record_form #therapeutic_procedures_nr').val();

      var death_date = jQuery('#add_observation_record_form #death_date').val();
      var hospitalized_reason_others_info = jQuery('#add_observation_record_form #hospitalized_reason_others_info').val();
      var anamneza_others_info = jQuery('#add_observation_record_form #anamneza_others_info').val();
      var disease_history_others_info = jQuery('#add_observation_record_form #disease_history_others_info').val();
      var epicrisis_others_info = jQuery('#add_observation_record_form #epicrisis_others_info').val();
      ...
      analysis_array.push({
        id: analysis_id,
        value:  jQuery('#add_observation_record_form #'+analysis_id).val()
      });
      <?php endforeach; ?>
      ...
      for (var i = 1; i <= temperature_set_number; i++) {
        temp_date = jQuery('#add_observation_record_form #temp_date_'+i).val();
        breath = jQuery('#add_observation_record_form #breath_'+i).val();
        ta = jQuery('#add_observation_record_form #ta_'+i).val();
        pulse = jQuery('#add_observation_record_form #pulse_'+i).val();
        temperature = jQuery('#add_observation_record_form #temperature_'+i).val();

        liquid = jQuery('#add_observation_record_form #liquid_'+i).val();
        diuresis = jQuery('#add_observation_record_form #diuresis_'+i).val();
        shit = jQuery('#add_observation_record_form #shit_'+i).val();
        diet = jQuery('#add_observation_record_form #diet_'+i).val();
      ...
      jQuery.ajax({
        ...
        success: function (data) {
          if (data.code == 1) {
            ...
            document.getElementById('add_observation_record_form').reset();
          }
          else {
      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="body">
            ...
            <?php echo form_open('observation_records/process_request',array("id"=>"add_observation_record_form")); ?>
