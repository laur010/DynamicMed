...
<script type="text/javascript">
  jQuery(document).ready(function(){
    ...
    jQuery(document).on('submit','#add_salon_form',function(e){
      e.preventDefault();

      var name = jQuery('#add_salon_form #name').val();
      var event = document.getElementById("department_id");
      var department_id = event.value;
      var capacity = jQuery('#add_salon_form #capacity').val();
      var description = jQuery('#add_salon_form #description').val();
      var oper = jQuery('#add_salon_form #operation').val();
      ...
      jQuery.ajax({
        ...
        success: function (data) {
          if (data.code == 1) {
            ...
            document.getElementById('add_salon_form').reset();
          }
          else {
  ...
  <div class="container-fluid">
    ...
    <div class="row clearfix">
      <div class="col-lg-12">
        <div class="card">
          <div class="header">
            <h2><strong>ADAUGARE</strong> Salon </h2>
          ...
          <div class="body">
            <?php echo form_open('salons/process_request',array("id"=>"add_salon_form")); ?>
            <input type="hidden" id="operation" name="operation" value="add"/>
            <div class="row clearfix">
              <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                <label for="department_id">Sectie</label>
              </div>
            ...
            <div class="row clearfix">
              ...
              <div class="col-lg-10 col-md-10 col-sm-8">
                <div class="form-group">
                  <input type="text" name="capacity" id="capacity"class="form-control" placeholder="Capacitate">
                </div>
              </div>
            </div>
            <div class="row clearfix">
              ...
              <div class="col-lg-10 col-md-10 col-sm-8">
                <div class="form-group">
                  <textarea rows="4" class="form-control no-resize" id="description" name="description" placeholder="Descriere"></textarea>
                </div>
              </div>
            </div>
            <div class="row clearfix">
