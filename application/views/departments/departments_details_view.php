  ...
  <div class="container-fluid">
    ...
    <div class="row clearfix">
      <div class="col-lg-12">
        <div class="card">
          <div class="header">
            <h2><strong>DETALII: </strong><?php echo $department['name'];?> </h2>
            ...
            <div class="row clearfix">
              ...
              <div class="col-lg-10 col-md-10 col-sm-8">
                <div class="form-group">
                  <input type="text" readonly name="name" value="<?php echo $department['name'];?>" id="name"class="form-control" placeholder="Nume">
                </div>
              </div>
            </div>
          </div>
